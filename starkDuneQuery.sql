...
FROM (
  ...
  WHERE
    ...
    AND NOT (
        "to" = 0xe37E2a01feA778BC1717d72Bd9f018B6A6B241D5 -- saddle lp
  ...
  WHERE
    ...
    AND NOT (
        ...
        OR "to" = 0xe37E2a01feA778BC1717d72Bd9f018B6A6B241D5 -- saddle lp
        OR "to" = 0xdec2157831D6ABC3Ec328291119cc91B337272b5 -- saddle swap 
        OR "to" = 0x16BEa2e63aDAdE5984298D53A4d4d9c09e278192 -- snowswap 
        OR "to" = 0xa919d7a5fb7ad4ab6f2aae82b6f39d181a027d35 --staking pod
        or "to" = 0x2b228842b97ab8a1f3dcd216ec5d553ada957915 -- rewards
    ) AND NOT (
        "from" = 0xe37E2a01feA778BC1717d72Bd9f018B6A6B241D5 -- saddle lp
        OR "from" = 0xa919d7a5fb7ad4ab6f2aae82b6f39d181a027d35 --staking pod
        or "from" = 0x2b228842b97ab8a1f3dcd216ec5d553ada957915 -- rewards
    )
  GROUP BY
    "to"
), balances AS (
